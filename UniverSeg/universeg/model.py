...
@validate_arguments
def universeg(version: Literal["v1"] = "v1", pretrained: bool = True) -> nn.Module:
    weights = {
        "v1": "/DiffusionMBIR/UniverSeg/ckpt/universeg_v1_nf64_ss64_STA.pt"
    }
    ...
    if pretrained:
        state_dict = torch.load(weights[version])
